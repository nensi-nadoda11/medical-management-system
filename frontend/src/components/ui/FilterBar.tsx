...
export const FilterBar = ({
  ...
  <section className="rounded-[28px] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(248,250,252,0.92),rgba(255,255,255,0.94))] p-4 shadow-[0_24px_58px_-42px_rgba(15,23,42,0.3)] md:p-5">
