...
export const billingModuleButtonClassName =
  "inline-flex min-h-[2.9rem] items-center justify-center rounded-[6px] border-2 border-slate-950/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(255,255,255,0.66))] px-4 text-sm font-semibold text-slate-950 shadow-[0_16px_30px_-24px_rgba(15,23,42,0.35),0_4px_14px_-12px_rgba(255,255,255,0.92),inset_0_1px_0_rgba(255,255,255,0.98),inset_0_-10px_18px_rgba(148,163,184,0.1)] backdrop-blur-xl transition hover:bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(255,255,255,0.74))] hover:shadow-[0_18px_34px_-22px_rgba(15,23,42,0.42),0_6px_18px_-12px_rgba(255,255,255,0.95),inset_0_1px_0_rgba(255,255,255,1),inset_0_-10px_18px_rgba(148,163,184,0.12)]";
